...
from eWeLink.base import SIGNAL_CONNECTED, SIGNAL_UPDATE, XDevice, XRegistryBase
...
async def sonoff_command(email, password, device_id, command):
    ...
    async with aiohttp.ClientSession() as session:
        ...
        # Here I'm assuming email authentication. You can also use phoneNumber.
        success = await registry.login(email, password)
        ...
        await registry.send(devices[device_id], {"switches": [{"outlet": 0, "switch": command}]})

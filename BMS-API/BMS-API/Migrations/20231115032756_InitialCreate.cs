        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    DeviceId = table.Column<int>(type: "integer", nullable: false),
                    DeviceCapabilityId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeviceReadings_DeviceCapabilities_DeviceCapabilityId",
                        column: x => x.DeviceCapabilityId,
                        principalTable: "DeviceCapabilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SensorReadings_DeviceCapabilities_DeviceCapabilityId",
                        column: x => x.DeviceCapabilityId,
                        principalTable: "DeviceCapabilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeviceReadings_DeviceCapabilityId",
                table: "DeviceReadings",
                column: "DeviceCapabilityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SensorReadings_DeviceCapabilityId",
